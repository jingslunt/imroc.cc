...
上一篇 [Thanos 架构详解](../build-cloud-native-large-scale-distributed-monitoring-system-2) 我们深入理解了 thanos 的架构设计与实现原理，现在我们来聊聊实战，分享一下如何部署和使用 Thanos。
...
![](https://imroc.cc/assets/blog/thanos-receiver-without-objectstore.png)
