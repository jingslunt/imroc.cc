...
# Date published
date: 2019-08-12T16:59:00+08:00

# Date updated
lastmod: 2019-08-12T16:59:00+08:00
...
![](https://imroc.cc/assets/meme/dengguangshi.png)
...
![](https://imroc.cc/assets/meme/emoji_analysis.png)

当然是先抓包看看啦，抓 server 端 NodePort 的包，发现异常时 server 能收到 SYN，但没响应 ACK:

![](https://imroc.cc/assets/blog/troubleshooting-k8s-network/no_ack.png)

反复执行 `netstat -s | grep LISTEN` 发现 SYN 被丢弃数量不断增加:

![](https://imroc.cc/assets/blog/troubleshooting-k8s-network/drop_syn.png)
...
![](https://imroc.cc/assets/meme/man_need_think.png)
...
![](https://imroc.cc/assets/meme/chijing2.png)
...
![](https://imroc.cc/assets/meme/laugh1.png)
...
![](https://imroc.cc/assets/meme/analysis_forever.png)
...
![](https://imroc.cc/assets/meme/emoji_jizhi.png)
...
![](https://imroc.cc/assets/meme/jugelizi.jpeg)
...
![](https://imroc.cc/assets/meme/physical_analysis.png)
...
![](https://imroc.cc/assets/blog/troubleshooting-k8s-network/nsswitch.png)

`hostLookupOrder` 函数决定域名解析顺序的策略，Linux 下，如果没有 `nsswitch.conf` 文件就 dns 比 hosts 文件优先 (`net/conf.go`):

![](https://imroc.cc/assets/blog/troubleshooting-k8s-network/hostLookupOrder.png)

可以看到 `hostLookupDNSFiles` 的意思是 dns first (`net/dnsclient_unix.go`):

![](https://imroc.cc/assets/blog/troubleshooting-k8s-network/hostLookupDNSFiles.png)
...
![](https://imroc.cc/assets/meme/cooldown_analysis.png)
...
![](https://imroc.cc/assets/meme/chijing1.png)
...
![](https://imroc.cc/assets/blog/troubleshooting-k8s-network/dns-id-conflict.png)
...
![](https://imroc.cc/assets/meme/chengsi.png)
...
![](https://imroc.cc/assets/blog/troubleshooting-k8s-network/musl-libc-make-dns-query.png)
...
![](https://imroc.cc/assets/meme/smoke_cooldown.png)
...
![](https://imroc.cc/assets/blog/troubleshooting-k8s-network/ipvs-proposal.png)
...
![](https://imroc.cc/assets/blog/troubleshooting-k8s-network/aws-lb-snat.png)
...
![](https://imroc.cc/assets/blog/troubleshooting-k8s-network/solve-in-iptables.png)

仔细一想，确实可行，打算有空实现下，重新提个 PR:
![](https://imroc.cc/assets/blog/troubleshooting-k8s-network/solve-in-prerouting.png)
